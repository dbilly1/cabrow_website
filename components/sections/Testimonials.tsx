    ...
    <section id="testimonials" className={s.section}>
      <div className="wave">
        <svg viewBox="0 0 1440 60" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M0,60 C480,0 960,60 1440,0 L1440,0 L0,0 Z" fill="var(--cream)" />
        </svg>
      </div>
      ...
      <div className="container">
        <div className={s.header}>
          ...
          <p className="section-sub">Real words from real families who trust Cabrow with their most precious ones.</p>
        </div>
        ...
        <div className={s.card}>
          ...
          <div className={s.author}>
            <div className={s.avatar} style={{ background: t.color }}>{t.initials}</div>
            <div>
        ...
        <div className={s.controls}>
          <button onClick={prev} className={s.btn} aria-label="Previous">←</button>
          ...
          <button onClick={next} className={s.btn} aria-label="Next">→</button>
        </div>
      </div>

      <div className="wave" style={{ marginTop: "72px" }}>
        <svg viewBox="0 0 1440 60" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M0,0 C480,60 960,0 1440,60 L1440,60 L0,60 Z" fill="var(--cream)" />
        </svg>
      </div>
    </section>
  );
