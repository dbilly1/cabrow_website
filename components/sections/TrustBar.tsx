...
const ITEMS = [
  {
    icon: <CalendarDots weight="fill" size={20} />,
    label: "Founded 2019",
    bg: "var(--orange-light)",
    color: "var(--orange)",
  },
  {
    icon: <Books weight="fill" size={20} />,
    label: "Preschool & Primary",
    bg: "var(--pink-light)",
    color: "var(--pink)",
  },
  {
    icon: <Flag weight="fill" size={20} />,
    label: "GES Curriculum",
    bg: "var(--green-light)",
    color: "var(--green)",
  },
  {
    icon: <Cross weight="fill" size={20} />,
    label: "Faith-Based Values",
    bg: "var(--yellow-light)",
    color: "var(--yellow)",
  },
