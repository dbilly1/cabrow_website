  ...
  return (
    <footer className={s.footer} id="footer">
      <div className={`container ${s.inner}`}>
        ...
        <div className={s.brand}>
          ...
          <p className={s.tagline}>
            Roots and Wings - Growing Today, Soaring Tomorrow. At Cabrow, we
            don&apos;t just teach. We raise children with care, faith, and joy.
          </p>
      ...
      <div className={`container ${s.bottom}`}>
        <p>
          © {new Date().getFullYear()} Cabrow Educational Center. All rights
          reserved.
        </p>
        <span>
          Choice Junction, Mallam-Kasoa Highway, Ghana &nbsp;·&nbsp;{" "}
          <a href="tel:0557110196" style={{ color: "inherit" }}>
            0557 110 196
          </a>
        </span>
      </div>
